...
import type { BridgeResult, EditRecipe, Field, LibraryChoiceView, LibraryCopyTextRequest, LibraryTextResult, LibraryView, Mode, Preset } from '../../../shared/teleprompter';
...
export function LibrarySurface({ library, mode, favoriteIds = new Set(), onFavorite, onApply, onCopy, onReadText }: LibrarySurfaceProps) {
...
function LibraryDetail({ record, kind, library, mode, choiceMap, artUrl, onClose, onApply, onCopy, onReadText }: { readonly record: RecordItem; readonly kind: 'preset' | 'edit-recipe'; readonly library: LibraryView; readonly mode: Mode; readonly choiceMap: ReadonlyMap<string, LibraryChoiceView>; readonly artUrl?: string; readonly onClose: () => void; readonly onApply: () => void; readonly onCopy?: LibrarySurfaceProps['onCopy']; readonly onReadText?: LibrarySurfaceProps['onReadText'] }) {
